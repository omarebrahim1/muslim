...
function createFooter() {
  ...
  footer.innerHTML = `
      <div class="developer" style="margin-bottom:10px;">
        Made By -  <i class="fa-solid fa-heart" style="color:tomato;"></i>
        <b>Omar Ebrahim</b>
      </div>
      <div class="links">
        <a href="https://www.facebook.com/omar.ebrahim.120/"
          ><i class="fa-brands fa-facebook fa-lg"></i
        ></a>
        <a href="https://www.linkedin.com/in/"
          ><i class="fa-brands fa-linkedin fa-lg"></i
        ></a>
        <a href="https://t.me/omarebrahim1"
          ><i class="fa-brands fa-telegram fa-lg"></i
        ></a>
        <a href="mailto:ebrahimomar493@gmail.com"
